...
CREATE TABLE item_masters (
	...
	hsn_code VARCHAR(20), 
	mrp DECIMAL(10, 2), 
	serial_count INTEGER NOT NULL DEFAULT '1', 
...
CREATE TABLE service_completions (
	...
	engineer_completion_code VARCHAR(10), 
...
CREATE INDEX ix_service_requests_completion_code ON service_requests (completion_code);
